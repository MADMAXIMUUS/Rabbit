...
import ru.rabbit.persian.components.TProfileTextField
import ru.rabbit.persian.components.TTopAppBar
import ru.rabbit.persian.foundation.icons

@OptIn(ExperimentalComposeUiApi::class)
@Composable
fun ProfileUsernameRoute(
    snackbarHostState: SnackbarHostState,
    viewModel: SetProfileUsernameViewModel = hiltViewModel(),
    onAuthenticate: () -> Unit
) {
...
fun SetUsernameScreen(
    state: SetProfileUsernameScreenState,
