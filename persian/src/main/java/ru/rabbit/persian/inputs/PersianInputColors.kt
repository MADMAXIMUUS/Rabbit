...
class InputColors internal constructor(
    ...
    private val successTrailingIconColor: Color,
    ...
    private val successSuffixColor: Color,
) {
    @Composable
    ...
    internal fun trailingIconColor(
        ...
        return rememberUpdatedState(
            when {
                ...
                isSuccess -> successTrailingIconColor
...
object PersianInputColors {
    ...
    fun primary(
        ...
        disabledTrailingIconColor: Color = MaterialTheme.colorScheme.onSurfaceVariant
            .copy(alpha = PersianContentStateDisabled),
        errorTrailingIconColor: Color = MaterialTheme.colorScheme.onSurfaceVariant,
        successTrailingIconColor: Color = MaterialTheme.colorScheme.onSurfaceVariant,
        ...
        disabledSuffixColor: Color = MaterialTheme.colorScheme.onSurface
            .copy(alpha = PersianContentStateDisabled),
        errorSuffixColor: Color = MaterialTheme.colorScheme.error,
        successSuffixColor: Color = MaterialTheme.colorScheme.onSurfaceVariant,
    ): InputColors =
        InputColors(
            //State Icon
            ...
            successTrailingIconColor = successTrailingIconColor,
            ...
            successSuffixColor = successSuffixColor
        )
}