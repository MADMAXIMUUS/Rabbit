...
fun SetProfileImageScreen(
            ...
            Surface(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    TTextButton(modifier = Modifier.fillMaxWidth(),
                        onClick = {
                            hideDialog()
                            val uri = RabbitFileProvider.getImageUri(context)
                            imageUri = uri
    ...
    Column(
        ...
        Text(
            ...
            text = stringResource(ru.rabbit.feature.auth.R.string.set_profile_picture_title),
        ...
        Text(
            modifier = Modifier.padding(horizontal = 40.dp),
            text = stringResource(ru.rabbit.feature.auth.R.string.set_profile_picture_hint),
                ...
                IconButton(
                    ...
                    Column(
                        ...
                        Icon(
                            ...
                            painter = MaterialTheme.icons.cameraEnhance,
                            contentDescription = "",
                            tint = MaterialTheme.colorScheme.primary
                        )
                        Text(
                            text = stringResource(ru.rabbit.feature.auth.R.string.upload),
                            style = MaterialTheme.typography.titleMedium,
        ...
        Column(
            ...
            Row(modifier = Modifier.fillMaxWidth()) {
                TOutlineButton(
                    ...
                    Text(stringResource(ru.rabbit.feature.auth.R.string.skip_button_label))
                }
                Spacer(modifier = Modifier.weight(0.1f))
                TButton(
